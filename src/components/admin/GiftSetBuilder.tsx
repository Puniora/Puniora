...
import { Gift, Plus, Trash2, ArrowRight, Loader2, Sparkles, Save } from "lucide-react";
    ...
    const handlePublish = async () => {
        ...
        try {
            ...
            const payload: Partial<Product> = {
                ...
                images: imageUrl ? [imageUrl] : [], // Use provided image or empty
                bundleItems: selectedItems,
                variants: [] // No variants for simple bundles
            };
            ...
            console.error(error);
            toast.error("Failed to publish gift set: " + error.message);
        } finally {
            setLoading(false);
        }
    };
            ...
            <div className="grid lg:grid-cols-3 gap-8">
                ...
                <Card className="lg:col-span-2 border-gold/20 shadow-lg relative overflow-hidden">
                    ...
                    <CardHeader className="pb-6">
                        <CardTitle className="text-2xl font-heading">Configure Your Bundle</CardTitle>
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <Input
                                        ...
                                        placeholder="https://example.com/gift-set.jpg"
                                    />
                                </div>
                                <div className="space-y-2">
                            ...
                            <div className="space-y-4">
                                <div className="bg-muted/30 p-6 rounded-xl border border-border space-y-4">
                                    ...
                                    <div className="pt-4 border-t border-border">
                                        <Label className="text-gold font-bold mb-1.5 block">Offer Price (₹)</Label>
                                    ...
                                    {Number(offerPrice) > 0 && (
                                        <div className="bg-green-500/10 text-green-600 p-2 rounded-lg text-center text-sm font-bold border border-green-500/20">
                                            Customer Saves: ₹{bundleSaving}
                                        </div>
                                    )}
                                </div>
